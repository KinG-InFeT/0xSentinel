...
class BanIP extends MySQL
{
	...
	public function ban_ip() {
		...
		while($row = mysql_fetch_array($lista)) {
			...
			."<td width='20%' style='border:1px solid #000;' align='center'><b><a href='admin.php?action=delete_ip&id=".$row['id']."'>[-Elimina-]</a></b></td>\n"
			."</tr>\n";
		}
		print "</table>";	
		print "\n<p align='right'><a href='admin.php?action=add_ip'>[-Add IP-]</a></p>\n";
	}
